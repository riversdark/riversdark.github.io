...
$$
\begin{aligned}
\textrm{complaints}_{n} & \sim \textrm{Poisson}(\textrm{sq_foot}_b\lambda_{n}) \\
\lambda_{n} & = \exp{(\eta_{n} )} \\
...
\log \lambda_{n} &= \alpha + \beta  {\rm traps}_{n} + \beta_{\rm super}  {\rm super}_{b} + \text{log_sq_foot}_{b}
\end{aligned}
$$
